  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6" data-testid="onboarding">
      <div className="max-w-4xl w-full">
        <Logo size={48} />
        <h1 className="font-display text-4xl md:text-5xl font-black mt-8">Who are you on Outclipped?</h1>
        <p className="text-gray-400 mt-3 max-w-xl">Pick the role that matches what you'll do most.</p>
