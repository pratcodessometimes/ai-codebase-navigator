...
const LIVE_CAMPAIGNS = [
  { name: "Gaming Highlights Vol. 7", bounty: 12500 },
  { name: "Podcast Cuts — Episode 42", bounty: 8000 },
  { name: "IRL Adventure Clips", bounty: 15000 },
  { name: "Sports Reels Showdown", bounty: 22000 },
  { name: "Commentary Masters", bounty: 9500 },
  { name: "Streamer Stories", bounty: 18500 },
  { name: "Late Night Talk Cuts", bounty: 7200 },
];
...
export default function Landing() {
  ...
  const ticker = [...LIVE_CAMPAIGNS, ...LIVE_CAMPAIGNS];
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden" data-testid="landing-page">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: Coins, color: "#2D2D2D", title: "Pool splits by performance", body: "Reward = your points ÷ campaign points × pool. Hit a million? +50% multiplier on top." },
            ].map((s, i) => (
      ...
      <section className="bg-black pt-16 pb-12 border-t-2 border-[#2D2D2D]" data-testid="socials-section">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <p className="text-xs text-gray-600 mt-14 font-mono">© OUTCLIP · OUTPERFORM. CLIMB. EARN.</p>
        </div>
      </section>
